...
// ✅ Updated: Allowed languages for non-pro users
const allowedLanguagesForNonPro = new Set(["javascript", "python", "ruby", "java", "cpp"]);
...
export const saveExecution = mutation({
  ...
  handler: async (ctx, args) => {
    try {
      ...
      if (!user.isPro && !allowedLanguagesForNonPro.has(args.language.toLowerCase())) {
      ...
      console.error("Error in saveExecution mutation:", error);
      throw error;
    }
  },
});
